def sonarCheck() {
    sh ''' 
        ...
        sonar-quality-gate.sh ${SONAR_USR} ${SONAR_PSW} 172.31.0.99 ${COMPONENT} // This gives the result of the scan and based on that either it will abort the pipeline or will proceed further.
